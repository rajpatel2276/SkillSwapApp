    ...
    <div className="bg-neutral-50/50 shadow-inner rounded-xl p-8 ring-1 ring-black/[.05]">
      ...
      <div className="space-y-8">
        <div>
          ...
          <div className="relative"><input type="text" value={teachInput} onChange={e => setTeachInput(e.target.value)} onKeyDown={e => {if (e.key === 'Enter') { e.preventDefault(); addSkill('teach', teachInput, setTeachInput); }}} placeholder="Add a skill and press Enter" className="w-full pl-4 pr-12 py-2 border border-neutral-300 rounded-lg focus:ring-2 focus:ring-primary"/><motion.button type="button" onClick={() => addSkill('teach', teachInput, setTeachInput)} className="absolute right-1 top-1/2 -translate-y-1/2 p-2 bg-primary text-white rounded-lg hover:bg-primary-dark"  ><HiPlus className="h-5 w-5"/></motion.button></div>
        </div>
        <div className="border-t border-neutral-200 pt-8">
          ...
          <div className="relative"><input type="text" value={learnInput} onChange={e => setLearnInput(e.target.value)} onKeyDown={e => {if (e.key === 'Enter') { e.preventDefault(); addSkill('learn', learnInput, setLearnInput); }}} placeholder="Add a skill and press Enter" className="w-full pl-4 pr-12 py-2 border border-neutral-300 rounded-lg focus:ring-2 focus:ring-primary"/><motion.button type="button" onClick={() => addSkill('learn', learnInput, setLearnInput)} className="absolute right-1 top-1/2 -translate-y-1/2 p-2 bg-primary text-white rounded-lg hover:bg-primary-dark"  ><HiPlus className="h-5 w-5"/></motion.button></div>
        </div>
      </div>
    </div>
  );
